...
import (
	...
	crewv1 "sigs.k8s.io/kubebuilder/testdata/project-v4-multimodule/apis/crew/v1"
	fizv1 "sigs.k8s.io/kubebuilder/testdata/project-v4-multimodule/apis/fiz/v1"
	foopolicyv1 "sigs.k8s.io/kubebuilder/testdata/project-v4-multimodule/apis/foo.policy/v1"
	foov1 "sigs.k8s.io/kubebuilder/testdata/project-v4-multimodule/apis/foo/v1"
	seacreaturesv1beta1 "sigs.k8s.io/kubebuilder/testdata/project-v4-multimodule/apis/sea-creatures/v1beta1"
	seacreaturesv1beta2 "sigs.k8s.io/kubebuilder/testdata/project-v4-multimodule/apis/sea-creatures/v1beta2"
	shipv1 "sigs.k8s.io/kubebuilder/testdata/project-v4-multimodule/apis/ship/v1"
	shipv1beta1 "sigs.k8s.io/kubebuilder/testdata/project-v4-multimodule/apis/ship/v1beta1"
	shipv2alpha1 "sigs.k8s.io/kubebuilder/testdata/project-v4-multimodule/apis/ship/v2alpha1"
	appscontrollers "sigs.k8s.io/kubebuilder/testdata/project-v4-multimodule/controllers/apps"
	crewcontrollers "sigs.k8s.io/kubebuilder/testdata/project-v4-multimodule/controllers/crew"
	fizcontrollers "sigs.k8s.io/kubebuilder/testdata/project-v4-multimodule/controllers/fiz"
	foocontrollers "sigs.k8s.io/kubebuilder/testdata/project-v4-multimodule/controllers/foo"
	foopolicycontrollers "sigs.k8s.io/kubebuilder/testdata/project-v4-multimodule/controllers/foo.policy"
	seacreaturescontrollers "sigs.k8s.io/kubebuilder/testdata/project-v4-multimodule/controllers/sea-creatures"
	shipcontrollers "sigs.k8s.io/kubebuilder/testdata/project-v4-multimodule/controllers/ship"
...
func main() {
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		...
		LeaderElectionID:       "cd0f74a2.testproject.org",
