...
func main() {
	...
	// More info:
	// - https://pkg.go.dev/sigs.k8s.io/controller-runtime@v0.24.0/pkg/metrics/server
	...
	if secureMetrics {
		...
		// https://pkg.go.dev/sigs.k8s.io/controller-runtime@v0.24.0/pkg/metrics/filters#WithAuthenticationAndAuthorization
