...
import (
	...
	// examplecomv1apply "sigs.k8s.io/kubebuilder/testdata/project-v4-multigroup/api/example.com/v1/applyconfiguration"
)
...
// +kubebuilder:rbac:groups=example.com.testproject.org,resources=applications,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=example.com.testproject.org,resources=applications/status,verbs=get;update;patch
// +kubebuilder:rbac:groups=example.com.testproject.org,resources=applications/finalizers,verbs=update
