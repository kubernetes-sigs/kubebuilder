...
import (
	...
	"sigs.k8s.io/kubebuilder/testdata/project-v4-multigroup-with-plugins/test/utils"
)

// namespace where the project is deployed in
const namespace = "project-v4-multigroup-with-plugins-system"

// serviceAccountName created for the project
const serviceAccountName = "project-v4-multigroup-with-plugins-controller-manager"

// metricsServiceName is the name of the metrics service of the project
const metricsServiceName = "project-v4-multigroup-with-plugins-controller-manager-metrics-service"
		...
		It("should have CA injection for mutating webhooks", func() {
			...
			verifyCAInjection := func(g Gomega) {
				cmd := exec.Command("kubectl", "get",
					...
					"project-v4-multigroup-with-plugins-mutating-webhook-configuration",
		...
		It("should have CA injection for validating webhooks", func() {
			...
			verifyCAInjection := func(g Gomega) {
				cmd := exec.Command("kubectl", "get",
					...
					"project-v4-multigroup-with-plugins-validating-webhook-configuration",
					"-o", "go-template={{ range .webhooks }}{{ .clientConfig.caBundle }}{{ end }}")
