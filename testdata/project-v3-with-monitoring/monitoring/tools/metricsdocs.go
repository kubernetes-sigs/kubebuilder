...
import (
	...
	"sigs.k8s.io/kubebuilder/testdata/project-v3-with-monitoring/monitoring/metrics/util"
)

// constant parts of the file
const (
	title      = "# sigs.k8s.io/kubebuilder/testdata/project-v3-with-monitoring Operator Metrics\n"
	background = "This document aims to help users that are not familiar with metrics exposed by the sigs.k8s.io/kubebuilder/testdata/project-v3-with-monitoring operator.\n" +
	...
	KVSpecificMetrics = "## sigs.k8s.io/kubebuilder/testdata/project-v3-with-monitoring Operator Metrics List\n"
