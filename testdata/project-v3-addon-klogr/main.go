...
import (
	...
	crewv1 "sigs.k8s.io/kubebuilder/testdata/project-v3-addon-klogr/api/v1"
	"sigs.k8s.io/kubebuilder/testdata/project-v3-addon-klogr/controllers"
...
func main() {
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		...
		LeaderElectionID:       "d5a3ffac.testproject.org",
	})
	if err != nil {
