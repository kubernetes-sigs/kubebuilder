...
import (
	...
	"sigs.k8s.io/kubebuilder/testdata/project-v4-declarative-v1/monitoring/metrics/util"
)
...
const (
	...
	KVSpecificMetrics = "## sigs.k8s.io/kubebuilder/testdata/project-v4-declarative-v1 Operator Metrics List\n"
