...
import (
	...
	fizcontrollers "sigs.k8s.io/kubebuilder/testdata/project-v3-multigroup/controllers/fiz"
	foocontrollers "sigs.k8s.io/kubebuilder/testdata/project-v3-multigroup/controllers/foo"
