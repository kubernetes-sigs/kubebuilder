...
import (
	...
	crewv1 "sigs.k8s.io/kubebuilder/testdata/project-v3-config-gen/api/v1"
	"sigs.k8s.io/kubebuilder/testdata/project-v3-config-gen/controllers"
...
func main() {
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		...
		LeaderElectionID:       "59e80f43.testproject.org",
	})
	if err != nil {
