...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *LakersCustomDefaulter) DeepCopyInto(out *LakersCustomDefaulter) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new LakersCustomDefaulter.
func (in *LakersCustomDefaulter) DeepCopy() *LakersCustomDefaulter {
	if in == nil {
		return nil
	}
	out := new(LakersCustomDefaulter)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *LakersCustomValidator) DeepCopyInto(out *LakersCustomValidator) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new LakersCustomValidator.
func (in *LakersCustomValidator) DeepCopy() *LakersCustomValidator {
	if in == nil {
		return nil
	}
	out := new(LakersCustomValidator)
	in.DeepCopyInto(out)
	return out
}
