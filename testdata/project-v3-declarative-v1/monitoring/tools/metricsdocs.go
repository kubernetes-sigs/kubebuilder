...
import (
	...
	"sigs.k8s.io/kubebuilder/testdata/project-v3-declarative-v1/monitoring/metrics/util"
)

// constant parts of the file
const (
	title      = "# sigs.k8s.io/kubebuilder/testdata/project-v3-declarative-v1 Operator Metrics\n"
	background = "This document aims to help users that are not familiar with metrics exposed by the sigs.k8s.io/kubebuilder/testdata/project-v3-declarative-v1 operator.\n" +
	...
	KVSpecificMetrics = "## sigs.k8s.io/kubebuilder/testdata/project-v3-declarative-v1 Operator Metrics List\n"
