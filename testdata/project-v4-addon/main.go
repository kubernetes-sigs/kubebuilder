...
import (
	...
	crewv1 "sigs.k8s.io/kubebuilder/testdata/project-v4-addon/api/v1"
	"sigs.k8s.io/kubebuilder/testdata/project-v4-addon/controllers"
...
func main() {
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		...
		LeaderElectionID:       "fda80751.testproject.org",
