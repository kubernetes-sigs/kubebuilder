...
var _ input.File = &VersionSuiteTest{}

// VersionSuiteTest scaffolds the suite_test.go file to setup the versions test
...
func (v *VersionSuiteTest) GetInput() (input.Input, error) {
	if v.Path == "" {
		v.Path = filepath.Join("api", v.Resource.Version, "suite_test.go")
	}
