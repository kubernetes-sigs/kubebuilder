...
var _ = Describe("Controller", func() {
	resources := []*resource.Resource{
		...
		{Group: "creatures", Version: "v2alpha1", Kind: "Kraken", Namespaced: false, CreateExampleReconcileBody: true},
		{Group: "ziltodia", Version: "v1", Kind: "Ziltoid", Namespaced: false, CreateExampleReconcileBody: false},
	}
