...
func NewAPIScaffolder(config config.Config, res resource.Resource, goModPath string) plugins.Scaffolder {
...
func (s *apiScaffolder) Scaffold() error {
	...
	goModBuilder := &api.GoMod{ControllerRuntimeVersion: v3scaffolds.ControllerRuntimeVersion}
	goModBuilder.Path = s.goModPath
