...
`
  ...
  # Edit the API Scheme
  nano pkg/api/v1beta1/frigate_types.go

  # Edit the Controller
  nano pkg/controllers/frigate/frigate_controller.go

  # Edit the Controller Test
  nano pkg/controllers/frigate/frigate_controller_test.go
...
func (p *createAPISubcommand) InjectResource(res *resource.Resource) error {
	...
	p.options.UpdateResource(p.resource, p.config, false)
