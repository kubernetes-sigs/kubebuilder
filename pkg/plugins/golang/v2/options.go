...
func (opts Options) GVK(isProjectVersion2 bool) resource.GVK {
	if isProjectVersion2 {
		return resource.GVK{
			Group:   opts.Group,
...
func (opts Options) NewResource(c *config.Config) *resource.Resource {
	res := &resource.Resource{
		Group:      opts.Group,
		Domain:     opts.Domain,
		Version:    opts.Version,
		Kind:       opts.Kind,
		Path:       resource.LocalPath(c.Repo, opts.Group, opts.Version, c.MultiGroup),
	...
	if !opts.DoAPI {
		if c.GetResource(opts.GVK(c.IsV2())) == nil {
