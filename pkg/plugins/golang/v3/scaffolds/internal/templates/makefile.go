...
controller-gen: ## Download controller-gen locally if necessary.
	GOBIN=$(LOCAL_BIN) go install sigs.k8s.io/controller-tools/cmd/controller-gen@{{ .ControllerToolsVersion }}

KUSTOMIZE = $(LOCAL_BIN)/kustomize
kustomize: ## Download kustomize locally if necessary.
	GOBIN=$(LOCAL_BIN) go install sigs.k8s.io/kustomize/kustomize/v3@{{ .KustomizeVersion }}
