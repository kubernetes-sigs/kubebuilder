...
func NewInitHelmScaffolder(cfg config.Config, force bool, dir string) plugins.Scaffolder {
...
func (s *initScaffolder) copyConfigFiles(targetDirectory string) error {
	configDirs := []struct {
		SrcDir  string
		DestDir string
		SubDir  string
