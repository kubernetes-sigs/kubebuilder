 ...
 */`)
	...
	err = pluginutil.InsertCode(
		filepath.Join(sp.ctx.Dir, "api/v1/cronjob_types.go"),
		`to be serialized.`, CronjobSpecExplainationV1)
	hackutils.CheckError("fixing cronjob_types.go", err)

	err = pluginutil.InsertCode(
		filepath.Join(sp.ctx.Dir, "api/v1/cronjob_types.go"),
		`type CronJobSpec struct {`, CronjobSpecStructV1)
	hackutils.CheckError("fixing cronjob_types.go", err)
	...
	err = pluginutil.InsertCode(
		filepath.Join(sp.ctx.Dir, "api/v1/cronjob_types.go"),
		`// Important: Run "make" to regenerate code after modifying this file`, CronjobListV1)
	hackutils.CheckError("fixing cronjob_types.go", err)
 ...
 */`)
	...
	err = pluginutil.InsertCode(
		filepath.Join(sp.ctx.Dir, "api/v2/cronjob_types.go"),
		`to be serialized.`, CronjobSpecExplainationV2)
	hackutils.CheckError("fixing cronjob_types.go", err)

	err = pluginutil.InsertCode(
		filepath.Join(sp.ctx.Dir, "api/v2/cronjob_types.go"),
		`type CronJobSpec struct {`, CronjobSpecStructV2)
	hackutils.CheckError("fixing cronjob_types.go", err)
	...
	err = pluginutil.InsertCode(
		filepath.Join(sp.ctx.Dir, "api/v2/cronjob_types.go"),
		`// Important: Run "make" to regenerate code after modifying this file`, CronjobListV2)
	hackutils.CheckError("fixing cronjob_types.go", err)
