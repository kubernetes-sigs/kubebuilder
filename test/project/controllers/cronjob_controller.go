...
+call .:func getScheduledTimeForJob
*/
...
+call .:func (r *CronJobReconciler) ConstructJobForCronJob
*/
...
+return func (r *CronJobReconciler) ConstructJobForCronJob
*/
...
+return func getScheduledTimeForJob
*/
