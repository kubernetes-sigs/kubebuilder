...
import (
	...
	"github.com/kubernetes-sigs/kubebuilder/test/projects/validations/pkg/client/clientset/versioned/scheme"
...
// AppsV1Client is used to interact with features provided by the apps.validation.com group.
type AppsV1Client struct {
	restClient rest.Interface
}

func (c *AppsV1Client) TestKinds(namespace string) TestKindInterface {
	return newTestKinds(c, namespace)
}
