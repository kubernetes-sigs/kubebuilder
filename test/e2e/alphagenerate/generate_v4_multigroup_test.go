...
func validateV4MultigroupProjectFile(kbc *utils.TestContext, projectFile string) {
	...
	Expect(krakenResource.Path).To(Equal("sigs.k8s.io/kubebuilder/testdata/project-v4-multigroup/api/sea-creatures/v1beta1"),
	...
	Expect(leviathanResource.Path).To(Equal("sigs.k8s.io/kubebuilder/testdata/project-v4-multigroup/api/sea-creatures/v1beta2"),
	...
	Expect(projectConfig.HasResource(healthCheckPolicyGVK)).To(BeTrue(), "HealthCheckPolicy API should be present in the PROJECT file")
	...
	Expect(healthCheckPolicyResource.Path).To(Equal("sigs.k8s.io/kubebuilder/testdata/project-v4-multigroup/api/foo.policy/v1"),
	...
	Expect(memcachedResource.Path).To(Equal("sigs.k8s.io/kubebuilder/testdata/project-v4-multigroup/api/example.com/v1alpha1"),
	...
	Expect(busyboxResource.Path).To(Equal("sigs.k8s.io/kubebuilder/testdata/project-v4-multigroup/api/example.com/v1alpha1"),
	...
	Expect(len(deployImageConfig.Resources)).To(Equal(2), "Expected at least one resource for the DeployImage plugin")
