...
func validateV4ProjectFile(kbc *utils.TestContext, projectFile string) {
	...
	Expect(projectConfig.HasResource(firstMatev2GVK)).To(BeTrue(), "FirstMate v2 API should be present in the PROJECT file")
...
func regenerateV4ProjectWith(kbc *utils.TestContext, projectOutputDir string) {
