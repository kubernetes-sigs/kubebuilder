...
var _ = Describe("kubebuilder", func() {
	Context("multi module plugin v1alpha1", func() {
		...
		It("should generate a runnable project with multi-module.go/v1-alpha1 options ", func() {
			...
			By("initializing a project with multi-module.go/v1-alpha")
			err = kbc.Init(
				"--plugins", "go/v3,multi-module.go/v1-alpha",
				"--project-version", "3",
				"--domain", kbc.Domain,
			)
			ExpectWithOffset(1, err).NotTo(HaveOccurred())
