...
var EditFlags = []external.Flag{
	{
		Name:  "namespace",
		Type:  "string",
		Usage: "namespace for the Prometheus instance",
	},
}
...
var EditMeta = plugin.SubcommandMetadata{
	...
	Add Prometheus monitoring with custom namespace:
	$ kubebuilder edit --plugins sampleexternalplugin/v1 --namespace monitoring
	`,
}
