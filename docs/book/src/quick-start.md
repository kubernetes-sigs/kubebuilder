...
<aside class="note">
<h4>Versions Compatibility and Supportability</h4>
...
<aside class="note">
<h4>Enabling shell autocompletion</h4>
...
<aside class="note">
<h4> Keeping your project up to date with ecosystem changes </h4>
