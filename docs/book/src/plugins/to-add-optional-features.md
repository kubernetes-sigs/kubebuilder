...
| [ssa.go.kubebuilder.io/v1-alpha][ssa] | `ssa/v1-alpha` | Optional helper plugin which scaffolds APIs with controllers using Server-Side Apply for safer field management when resources are shared between controllers and users.    |
