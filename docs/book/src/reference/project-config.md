...
Following an example of an PROJECT file config file which is the result of an project generated with two APIs using the [Deploy Image Plugin](../plugins/deploy-image-plugin-v1-alpha.md).
