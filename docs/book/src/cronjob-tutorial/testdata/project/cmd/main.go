...
func main() {
	...
	// More info:
	// - https://pkg.go.dev/sigs.k8s.io/controller-runtime@v0.20.3/pkg/metrics/server
	...
	if secureMetrics {
		...
		// https://pkg.go.dev/sigs.k8s.io/controller-runtime@v0.20.3/pkg/metrics/filters#WithAuthenticationAndAuthorization
