...
Kubebuilder 搭建了一个设置测试环境基本工作的 `controllers/suite_test.go` 框架文件。
...
// 这些测试示例是使用的 Ginkgo (BDD-style Go 测试框架)。学习更多关于 Ginkgo 请参考http://onsi.github.io/ginkgo/。
...
var cfg *rest.Config
var k8sClient client.Client // 您将在你的测试中使用这个 client 。
...
var _ = BeforeSuite(func(done Done) {
	...
	/*
		首先，配置 envtest 集群从 Kubebuilder 为您创建搭建支架中的 CRD 目录下。
	*/
	...
	*/
	...
	/*
		...
		这确保了 CronJob 的 API/Kind 将会被用在我们测试控制器中。
	*/
	...
	*/
	...
	/*
		...
		一旦你已经添加了下面的代码，你将可以删除掉上面的 k8sClient，因为你可以从 manager 中获取到 k8sClient (如下所示)。
	*/
