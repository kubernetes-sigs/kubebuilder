...
The project also includes launch configurations under the
...
launch the controller on a cluster, but once you start writing the
controller, it will also hold CustomResourceDefinitions, RBAC
